...
| Buttons (including anchor links)     | Buy online button                        | - test if button redirects to amazon;<br> - test if search of a given book performed correctly;<br> - test if amazon page opens in a new tab                                                                                                                                                                                                                                                                                  | Initially there was an issue<br>with '&' symbol but<br>function was adjusted<br>to replace it with 'and'. |
