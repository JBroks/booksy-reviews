...
|<th style="width:10%">Feature type</th>| <th style="width:10%">Feature</th>       |       <th style="width:70%">Tests</th> | <th style="width:10%">Bugs</th> |
| ------------------------------------ | :--------------------------------------: | :-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------: | :------------------------------------------------------:|
...
| Forms                                | Sign up form                             | - test if input validation works correctly for each field;<br> - test if there is any field left empty the form cannot be submitted;<br> - test if submitted form saves data correctly into the database;<br> - test if password hashing works i.e. password saved to database is hashed;                                                                                                                                       | Initially username was case sensitive but that was fixed by applying python `lower()` method to the username. |
|                                      | Sign in form                             | - test if input validation works correctly for each field;<br> - test if there is any field left empty the form cannot be submitted;<br> - test is user can log in using incorrect password;                                                                                                                                                                                                                                   | Initially username was case sensitive but that was fixed by applying python `lower()` method to the username. |
...
|                                      | Update comment form, Edit review form    | - test if update forms pull data correctly from the database;<br> - test if input validation works correctly for each field;<br> - test if there is any field left empty the form cannot be submitted;<br> - test if submitted form saves data correctly into the database;                                                                                                                                                     | Bug related to updates in situation when only some fields where update other fields where removed. Bug fixed using `$set` mongoDB operator to only update fields edited by the user. |
